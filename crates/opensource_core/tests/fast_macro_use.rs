...
fn slices_fast_fixture_from_multiple_root_angles() {
    let cases = [
        ...
        SliceAngle {
            label: "request-facade-root",
            roots: &["open_request_facade"],
            present: &[
                "pub fn open_request_facade",
                "fn client_start_request",
                "mod request_facade",
                "macro_rules! req",
                "pub(crate) use req",
        ...
        SliceAngle {
            ...
            absent: &[
                "dead_private_seed",
                "shared_mobile_client_if_initialized",
                "pub fn open_layered_client",
                "pub struct FacadeObject",
                "pub fn open_transport_bundle",
                "include_str!(\"guidelines/core.md\")",
        ...
        SliceAngle {
            ...
            present: &[
                ...
                "pub mod records",
                "pub use records::*",
                "SharedRecord as BarrelRecord",
                "SharedMode as BarrelMode",
                "BarrelRecord",
                "BarrelMode",
