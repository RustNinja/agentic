...
local path dependencies, package entry files including auto-discovered bins,
Rust syntax, external module files, and build-script paths. `--feedback` runs
this preflight first and fails
