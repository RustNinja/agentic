...
| Fast macro/use corpus | `fast_macro_use.rs`, `fixtures/fast_macro_use` | Tiny checked-in multi-package workspace for quick iteration across renamed imports, local shadows, custom derives, attribute macros, macro_rules, include-generated source, trait imports, and dead pruning |
